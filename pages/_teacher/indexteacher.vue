      ...
      <v-row>
        <v-col cols="12" sm="8">
            ...
            <v-row>
                ...
                <v-list-item three-line>
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >Welcome back {{ user.firstname }} {{ user.lastname }}. We
                      are glad here.<br />
                      Inspire the best work in people.enabling them to acheive
                    </v-list-item-subtitle>
                    <v-list-item-subtitle> thier goals. </v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <v-card-actions>
                  <v-btn class="px-3" color="amber accent-3" rounded>
                    View Details
                  </v-btn>
                </v-card-actions>
              </v-col>
              <v-col cols="12" sm="4">
                <v-avatar size="250" tile class="mt-n16 hidden-sm-and-down">
                  <v-img
                    :src="require('~/assets/learning-animate.svg')"
                  ></v-img>
                </v-avatar>
              </v-col>
            </v-row>
          ...
          <v-toolbar flat color="rgba(0,0,0,0)" dense class="my-1">
            ...
            <v-spacer></v-spacer>
            <span
              ><v-btn text class="grey--text" href="/course/classroomteacher">
        ...
        <v-col cols="12" md="4">
          <v-card class="rounded-xl pa-4" color="#FFFFFF" flat>
            <v-card
              color=" rounded-xl "
              class="mx-auto"
              style="border: 1px solid #b388ff"
            ...
            <div class="mt-4">
              <v-card color="white" class="rounded-xl mx-4 pa-10" flat>
                <div class="text-center">
                  <span
                    >Enjoy<strong> your</strong> course teach and learn
                    fun</span
                  >
