      ...
      <v-container class="pa-6 md-auto" style="background-color: #ede7f6">
        ...
        >
          <v-tabs color="#7776AC" v-model="tab">
            ...
            <v-tab-item>
              <testssolution
                v-on:ChangeTestSolution="updateTestSolution($event)"
              ></testssolution>
            </v-tab-item>
            <v-tab-item>
              <exampletestcases
                v-on:ChangeExampleTestCase="updateExampleTestCase($event)"
              ></exampletestcases>
            </v-tab-item>
            <v-tab-item
              ><test-cases
            ...
            <v-tab-item
              ><initsolution
                v-on:ChangeInitSolution="updateInitSolution($event)"
              ></initsolution
            ></v-tab-item>
        ...
        <div class="pa-2">
          <v-btn
            ...
            @click="submit"
          >
            Create Question With Test</v-btn
          >
          <div v-if="spanVisible"></div>
        </div>
        ...
        >
          ...
          <div style="color: red" v-if="validateresultrealtest.code == 500">
    ...
    submit: function () {
      if (
        ...
        this.$store
          ...
          .then((resp) =>
            this.$router.push(
              "/" + this.$route.params.course + "/question/showallquestion"
            )
          )
